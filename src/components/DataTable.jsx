import { Box, FormControl, MenuItem, Select, TextField, Typography, Table, TableHead, TableRow, TableCell, TableBody, IconButton, Popover } from "@mui/material";
...
export default function DataTable({
    ...
    const [anchorElOptions, setAnchorElOptions] = useState(Array(data.length).fill(null));
    ...
    return (
        ...
        >
                    ...
                    <TableBody>
                        {
                            data.map((row, i) => (
                                <TableRow>
                                    ...
                                    >
                                        <IconButton
                                            onClick={(event) => handleOptionClick(event, i)}
                                        >
                                            <MoreVert />
                                        </IconButton>
            ...
            >
                <Typography>
                    {page * rowsPerPage + 1}-{data.length >= rowsPerPage ? rowsPerPage * (page + 1) : data.length} de {data.length}
                </Typography>
            </Box>
        </Box>
    );
